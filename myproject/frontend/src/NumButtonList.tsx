...
function NumButtonList() {
    return (
        <div className={style.numButtonList}>
            ...
            <NumButton num={8} text="0x8: 0b 0000" />
            <NumButton num={9} text="0x9: 0b 0001" />
            <NumButton num={10} text="0xA: 0b 0010" />
            <NumButton num={11} text="0xB: 0b 0011" />
            <NumButton num={12} text="0xC: 0b 0100" />
            <NumButton num={13} text="0xD: 0b 0101" />
            <NumButton num={14} text="0xE: 0b 0110" />
            <NumButton num={15} text="0xF: 0b 0111" />
        </div>
    );
}
